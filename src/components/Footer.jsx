...
import { LogoLinkedin, LogoTelegram, Envelope, Handset } from "@gravity-ui/icons";
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-4">
              <Link aria-label="LinkedIn" className="p-2 bg-white/10 hover:bg-white/20 rounded-full text-white transition-all" href="#">
                <LogoLinkedin size="{20}"/>
              </Link>
              <Link aria-label="Telegram" className="p-2 bg-white/10 hover:bg-white/20 rounded-full text-white transition-all" href="#">
                <LogoTelegram size="{20}"/>
              </Link>
            </div>
          </div>
